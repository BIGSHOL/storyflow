    ...
    // ==================== Existing Templates ====================
    {
        ...
        sections: [
            ...
            },
            {
                ...
                mediaType: 'image',
                mediaUrl: 'https://loremflickr.com/1280/720/gadget?lock=2',
                textAlignment: 'left',
                textColor: '#ffffff',
                backgroundColor: '#000000',
                overlayOpacity: 0.6,
            },
            {
                ...
                mediaType: 'image',
                mediaUrl: 'https://loremflickr.com/800/600/app?lock=3',
                textAlignment: 'left',
                splitRatio: 50,
                textColor: '#ffffff',
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                cards: [
                    { id: '1', title: '빠른 속도', description: '기존 대비 3배 빠른 처리 속도', imageUrl: 'https://loremflickr.com/400/300/fast?lock=7' },
                    { id: '2', title: '쉬운 사용', description: '직관적인 인터페이스', imageUrl: 'https://loremflickr.com/400/300/ui?lock=8' },
                    { id: '3', title: '24/7 지원', description: '언제든 도움을 받으세요', imageUrl: 'https://loremflickr.com/400/300/support?lock=9' },
                ],
            },
            {
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                mediaType: 'image',
                mediaUrl: 'https://loremflickr.com/800/600/dish?lock=11',
                textAlignment: 'left',
                splitRatio: 50,
                textColor: '#ffffff',
            ...
            },
            {
                ...
                backgroundColor: '#7c2d12',
                cards: [
                    { id: '1', title: '스테이크', description: '35,000원\n프리미엄 한우', imageUrl: 'https://loremflickr.com/400/300/steak?lock=12' },
                    { id: '2', title: '파스타', description: '18,000원\n수제 면발', imageUrl: 'https://loremflickr.com/400/300/pasta?lock=13' },
                    { id: '3', title: '리조또', description: '22,000원\n이탈리안 스타일', imageUrl: 'https://loremflickr.com/400/300/risotto?lock=14' },
                ],
            },
            {
                layout: LayoutType.SPLIT_LEFT,
                ...
                mediaType: 'image',
                mediaUrl: 'https://loremflickr.com/800/600/restaurant-interior?lock=15',
                textAlignment: 'left',
                splitRatio: 50,
                textColor: '#ffffff',
                backgroundColor: '#431407',
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                mediaType: 'image',
                mediaUrl: 'https://loremflickr.com/800/600/apartment?lock=17',
                textAlignment: 'left',
                splitRatio: 50,
                textColor: '#ffffff',
            ...
            },
            {
                ...
                backgroundColor: '#1e40af',
                galleryImages: [
                    { id: '1', url: 'https://loremflickr.com/800/600/livingroom?lock=18', caption: '거실' },
                    { id: '2', url: 'https://loremflickr.com/800/600/kitchen?lock=19', caption: '주방' },
                    { id: '3', url: 'https://loremflickr.com/800/600/bedroom?lock=20', caption: '안방' },
                    { id: '4', url: 'https://loremflickr.com/800/600/bathroom?lock=21', caption: '욕실' },
                ],
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                mediaType: 'image',
                mediaUrl: 'https://loremflickr.com/800/600/coding?lock=23',
                textAlignment: 'left',
                splitRatio: 50,
                textColor: '#ffffff',
            ...
            },
            {
                ...
                mediaType: 'image',
                mediaUrl: 'https://loremflickr.com/800/600/integration?lock=24',
                textAlignment: 'left',
                splitRatio: 50,
                textColor: '#ffffff',
                backgroundColor: '#0f172a',
